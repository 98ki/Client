...
public class StickyScrollView extends ScrollView {
	...
	private BottomScrollerListener listener;
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if (t + getHeight() >= computeVerticalScrollRange()) {
			// System.out.println("-------------t:" + t + "--height:"
			// + getHeight() + "--range:" + computeVerticalScrollRange());
	...
	// TODO
	// 判断是否滑到了底部
	public void setOnBottomListener(BottomScrollerListener listener) {
	...
	public interface BottomScrollerListener {
		void scrollBottom();
	}
}
