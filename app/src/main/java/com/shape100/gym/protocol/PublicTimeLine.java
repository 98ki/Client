...
public class PublicTimeLine extends HttpTask {
	private static final Logger log = Logger.getLogger("PublicTimeLine");
	private static final String URL = "/statuses/public_timeline.json";
	private ProtocolHandler handler;

	public PublicTimeLine(ProtocolHandler handler, int count, int page) {
