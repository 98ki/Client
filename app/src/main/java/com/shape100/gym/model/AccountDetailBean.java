...
/**
 * 
 * project：shape100 class：AccountDetail desc： author：zpy zpy@98ki.com create
 * date：2014-11-17 下午6:07:41 modify author: zpy update date：2014-11-17 下午6:07:41
 * update remark：
 * 
 * @version
 * 
...
public class AccountDetailBean implements Serializable {
	...
	private String profileImagePicId;

	public AccountDetailBean() {

	}

	public AccountDetailBean(int userId, String name, String screenName,
			String location, String description, String profileImageUrl,
			String url, String protect, int followersCount, int friendsCount,
			int favoritesCount, int utcOffset, String timeZone,
	...
	public HashMap<String, String> toHashMap() {
		...
		mMap.put(this.getCertificationKey(), certification);
	...
	public String getProfileImagePicId() {
		return profileImagePicId;
	}

	public void setProfileImagePicId(String profileImagePicId) {
		this.profileImagePicId = profileImagePicId;
	}

	public String getProfileImagePicIdKey() {
		return "profile_image_pic_id";
	}
